  ...
  return (
    <div id="contact" className="m-20">
      <div className="ml-8 flex">
        <h2 className="text-4xl font-semibold pr-5 border-r-2">Get in touch</h2>
      ...
      <div className="ml-8 w-11/12 ">
        <input
          ...
          className="h-16 text-slate-900 bg-gray-300 text-xl w-1/4 border-2 border-gray-300 p-4 focus:outline-0 "
        />
        <input
          type="email"
          placeholder="E-mail"
          className="h-16 text-slate-900 bg-gray-300 text-xl w-1/4 border-2 m-8 border-gray-300 p-4 focus:outline-0 "
        />
        <input
          type="text"
          placeholder="Phone"
